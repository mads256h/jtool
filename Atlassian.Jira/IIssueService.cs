...
namespace Atlassian.Jira
{
    ...
    public interface IIssueService
    {
        ...
        Task<string> GetIssueJsonAsync(string issueKey, CancellationToken token = default(CancellationToken));
        ...
        Task SetOriginalEstimateAsync(Issue issue, string newValue, CancellationToken token = default);

        Task SetTimeRemainingAsync(Issue issue, string newValue, CancellationToken token = default);
